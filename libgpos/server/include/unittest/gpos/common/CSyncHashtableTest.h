...
namespace gpos
{
	...
	private:
		...
		typedef CSyncHashtable<SElem, ULONG, CSpinlockDummy> SElemHashtable;

		typedef CSyncHashtableAccessByKey<SElem, ULONG, CSpinlockDummy> SElemHashtableAccessor;

		typedef CSyncHashtableIter<SElem, ULONG, CSpinlockDummy> SElemHashtableIter;

		typedef CSyncHashtableAccessByIter<SElem, ULONG, CSpinlockDummy> SElemHashtableIterAccessor;
		...
		public:
			// ctor
			SElemTest(SElemHashtable &sht, SElem *rgelem, CEvent *pevent = NULL)
				: m_sht(sht), m_rgelem(rgelem), m_pevent(pevent), m_ulStarted(0)
			{
			}
		...
		static void *PvUnittest_IteratorsRun(IMemoryPool *, SElemHashtable &, SElem *, ULONG);
